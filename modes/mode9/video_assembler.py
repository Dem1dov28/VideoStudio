...
def assemble_mode9_video(
    ...
    if use_speed_ramping:
        try:
            ...
            logger.info("[Mode9 Assembler] Applied SPEED RAMPING: slow start → fast middle → slow end")
        except Exception as e:
            logger.warning(f"[Mode9 Assembler] Speed ramping failed, using constant speed: {e}")
