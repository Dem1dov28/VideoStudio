    ...
    *,
    ...
    hum = HumanMessage(
        content=(
            ...
            "If mode5_sub_mode is unwritten_chapter: enforce archival-investigation visual canon — "
            "evidence-first scenes (declassified folders, maps, desks, witness environments, war-room traces), "
            "muted dark palette (sepia / charcoal / faded olive), restrained documentary realism, "
            "no glossy modern neon look, no anachronistic props.\n\n"
