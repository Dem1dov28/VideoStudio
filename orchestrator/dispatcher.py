...
async def _run_pipeline_wrapped(
    ...
    if mode == 8:
        ...
        return await run_mode8_pipeline(
            ...
            language=language or "ru",
            control=control,
            use_keyframes=mode8_use_keyframes,
            start_frame_path=mode8_start_frame_path,
            end_frame_path=mode8_end_frame_path,
        )
...
async def run_pipeline(
    ...
    try:
        return await _run_pipeline_wrapped(
            ...
            mode8_use_keyframes=mode8_use_keyframes,
            mode8_start_frame_path=mode8_start_frame_path,
            mode8_end_frame_path=mode8_end_frame_path,
